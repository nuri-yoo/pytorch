...
# Autotune gemm configs at fusion time (epilogue and prologue), skipping unfused autotuning
autotune_gemm_at_epilogue_fusion_time = (
    os.environ.get("TORCHINDUCTOR_AUTOTUNE_GEMM_AT_FUSION_TIME") == "1"
    or os.environ.get("TORCHINDUCTOR_AUTOTUNE_GEMM_AT_EPILOGUE_FUSION_TIME") == "1"
)
