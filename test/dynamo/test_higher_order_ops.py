...
class GraphModule(torch.nn.Module):
    def forward(self, L_x_: "f32[4, 3]"):
        ...
        _wrap_for_grad: "f32[4, 3]" = torch._C._functorch._wrap_for_grad(l_x_, 2);  _wrap_for_grad = None

        _make_dual: "f32[4, 3]" = torch._make_dual(l_x_, _add_batch_dim, level = 0);  l_x_ = _add_batch_dim = None
        ...
        _unwrap_for_grad: "f32[4, 3]" = torch._C._functorch._unwrap_for_grad(sin, 3)
        ...
        getitem_2: "f32[4, 3]" = _autograd_grad[0];  _autograd_grad = None

        _remove_batch_dim: "f32[12, 4, 3]" = torch._functorch.predispatch._remove_batch_dim(getitem_2, 3, 12, 0);  getitem_2 = None

        _vmap_decrement_nesting = torch._functorch.predispatch._vmap_decrement_nesting();  _vmap_decrement_nesting = None

        split = _remove_batch_dim.split((12,), dim = 0);  _remove_batch_dim = None
        getitem_3: "f32[12, 4, 3]" = split[0];  split = None

        view_2: "f32[4, 3, 4, 3]" = getitem_3.view((4, 3, 4, 3));  getitem_3 = None

        _unpack_dual = torch._unpack_dual(view_2, level = 0);  view_2 = None
        getitem_4: "f32[4, 3, 4, 3]" = _unpack_dual[0]
        getitem_5: "f32[4, 3, 4, 3]" = _unpack_dual[1];  _unpack_dual = None

        _unwrap_for_grad_1: "f32[4, 3, 4, 3]" = torch._C._functorch._unwrap_for_grad(getitem_4, 2);  getitem_4 = _unwrap_for_grad_1 = None
        _unwrap_for_grad_2: "f32[4, 3, 4, 3]" = torch._C._functorch._unwrap_for_grad(getitem_5, 2);  getitem_5 = None
        ...
        split_1 = movedim.split((12,), dim = -1);  movedim = None
        getitem_6: "f32[4, 3, 4, 3, 12]" = split_1[0];  split_1 = None

        unflatten: "f32[4, 3, 4, 3, 4, 3]" = getitem_6.unflatten(-1, (4, 3));  getitem_6 = None
        return (unflatten,)
""",
        )
...
class GraphModule(torch.nn.Module):
    def forward(self, L_x_: "f32[4, 3]", L_y_: "f32[3, 4]"):
        ...
        _wrap_for_grad_1: "f32[3, 4]" = torch._C._functorch._wrap_for_grad(l_y_, 2);  _wrap_for_grad_1 = None

        _make_dual: "f32[3, 4]" = torch._make_dual(l_y_, _add_batch_dim, level = 0);  l_y_ = _add_batch_dim = None

        _saved_tensors_hooks_disable = torch._C._autograd._saved_tensors_hooks_disable("torch.func.{grad, vjp, jacrev, hessian} don't yet support saved tensor hooks. Please open an issue with your use case.");  _saved_tensors_hooks_disable = None
        _grad_increment_nesting = torch._C._functorch._grad_increment_nesting();  _grad_increment_nesting = None

        _wrap_for_grad_2: "f32[4, 3]" = torch._C._functorch._wrap_for_grad(_wrap_for_grad, 3);  _wrap_for_grad = None
        _wrap_for_grad_3: "f32[3, 4]" = torch._C._functorch._wrap_for_grad(_make_dual, 3);  _make_dual = None

        set_inplace_requires_grad_allowed = torch._C._functorch.set_inplace_requires_grad_allowed(True);  set_inplace_requires_grad_allowed = None

        _set_tensor_requires_grad: "f32[3, 4]" = torch._functorch.eager_transforms._set_tensor_requires_grad(_wrap_for_grad_3);  _set_tensor_requires_grad = None

        set_inplace_requires_grad_allowed_1 = torch._C._functorch.set_inplace_requires_grad_allowed(False);  set_inplace_requires_grad_allowed_1 = None

        sin: "f32[4, 3]" = _wrap_for_grad_2.sin();  _wrap_for_grad_2 = None
        ...
        _autograd_grad = torch._functorch.eager_transforms._autograd_grad([sin], [_wrap_for_grad_3], [_add_batch_dim_1], retain_graph = True, create_graph = True);  sin = _wrap_for_grad_3 = _add_batch_dim_1 = None
        getitem_2: "f32[3, 4]" = _autograd_grad[0];  _autograd_grad = None

        _remove_batch_dim: "f32[12, 3, 4]" = torch._functorch.predispatch._remove_batch_dim(getitem_2, 3, 12, 0);  getitem_2 = None

        _vmap_decrement_nesting = torch._functorch.predispatch._vmap_decrement_nesting();  _vmap_decrement_nesting = None

        split = _remove_batch_dim.split((12,), dim = 0);  _remove_batch_dim = None
        getitem_3: "f32[12, 3, 4]" = split[0];  split = None

        view_2: "f32[4, 3, 3, 4]" = getitem_3.view((4, 3, 3, 4));  getitem_3 = None

        _unpack_dual = torch._unpack_dual(view_2, level = 0);  view_2 = None
        getitem_4: "f32[4, 3, 3, 4]" = _unpack_dual[0];  _unpack_dual = None

        zeros_like: "f32[4, 3, 3, 4]" = torch.zeros_like(getitem_4)

        _unwrap_for_grad_1: "f32[4, 3, 3, 4]" = torch._C._functorch._unwrap_for_grad(getitem_4, 2);  getitem_4 = _unwrap_for_grad_1 = None
        _unwrap_for_grad_2: "f32[4, 3, 3, 4]" = torch._C._functorch._unwrap_for_grad(zeros_like, 2);  zeros_like = None
        ...
        split_1 = movedim.split((12,), dim = -1);  movedim = None
        getitem_5: "f32[4, 3, 3, 4, 12]" = split_1[0];  split_1 = None

        unflatten: "f32[4, 3, 3, 4, 3, 4]" = getitem_5.unflatten(-1, (3, 4));  getitem_5 = None""",
        )
...
class GraphModule(torch.nn.Module):
    def forward(self, L_x_: "f32[4, 3]"):
        ...
        _unwrap_for_grad: "f32[4, 3]" = torch._C._functorch._unwrap_for_grad(sin, 1)
        ...
        getitem_1: "f32[4, 3]" = _autograd_grad[0];  _autograd_grad = None

        _remove_batch_dim: "f32[12, 4, 3]" = torch._functorch.predispatch._remove_batch_dim(getitem_1, 1, 12, 0);  getitem_1 = None

        _vmap_decrement_nesting = torch._functorch.predispatch._vmap_decrement_nesting();  _vmap_decrement_nesting = None

        split = _remove_batch_dim.split((12,), dim = 0);  _remove_batch_dim = None
        getitem_2: "f32[12, 4, 3]" = split[0];  split = None

        view_1: "f32[4, 3, 4, 3]" = getitem_2.view((4, 3, 4, 3));  getitem_2 = None
        return (view_1,)
""",
        )
...
class GraphModule(torch.nn.Module):
    def forward(self, L_x_: "f32[4, 3]", L_y_: "f32[3, 4]"):
        ...
        _unwrap_for_grad: "f32[3, 4]" = torch._C._functorch._unwrap_for_grad(sin, 1)
        ...
        getitem_1: "f32[3, 4]" = _autograd_grad[0];  _autograd_grad = None

        _remove_batch_dim: "f32[12, 3, 4]" = torch._functorch.predispatch._remove_batch_dim(getitem_1, 1, 12, 0);  getitem_1 = None

        _vmap_decrement_nesting = torch._functorch.predispatch._vmap_decrement_nesting();  _vmap_decrement_nesting = None

        split = _remove_batch_dim.split((12,), dim = 0);  _remove_batch_dim = None
        getitem_2: "f32[12, 3, 4]" = split[0];  split = None

        view_1: "f32[3, 4, 3, 4]" = getitem_2.view((3, 4, 3, 4));  getitem_2 = None
        return (view_1,)
""",
        )
...
class GraphModule(torch.nn.Module):
    def forward(self, L_x_: "f32[4, 3]", L_y_: "f32[3, 4]"):
        ...
        _unwrap_for_grad: "f32[4, 3]" = torch._C._functorch._unwrap_for_grad(_wrap_for_grad, 1);  _wrap_for_grad = None

        sin: "f32[3, 4]" = _wrap_for_grad_1.sin()

        _unwrap_for_grad_1: "f32[3, 4]" = torch._C._functorch._unwrap_for_grad(sin, 1)
...
class GraphModule(torch.nn.Module):
    def forward(self, L_x_: "f32[5]"):
        ...
        _unwrap_for_grad: "f32[]" = torch._C._functorch._unwrap_for_grad(sum_1, 1);  sum_1 = None
...
class GraphModule(torch.nn.Module):
    def forward(self, L_v_: "f32[5]", L_x_: "f32[5]"):
        ...
        sin: "f32[5]" = _wrap_for_grad.sin()
        cos: "f32[5]" = _wrap_for_grad.cos();  _wrap_for_grad = None

        _unwrap_for_grad: "f32[5]" = torch._C._functorch._unwrap_for_grad(sin, 1)
        _unwrap_for_grad_1: "f32[5]" = torch._C._functorch._unwrap_for_grad(cos, 1)
...
class GraphModule(torch.nn.Module):
    def forward(self, L_x_: "f32[5]"):
        ...
        _unwrap_for_grad: "f32[5]" = torch._C._functorch._unwrap_for_grad(_wrap_for_grad, 1);  _wrap_for_grad = _unwrap_for_grad = None

        sum_1: "f32[]" = sin.sum();  sin = None

        _unwrap_for_grad_1: "f32[]" = torch._C._functorch._unwrap_for_grad(sum_1, 1);  sum_1 = None
...
class GraphModule(torch.nn.Module):
    def forward(self, L_x_: "f32[3, 3, 3]"):
        ...
        _unwrap_for_grad: "f32[]" = torch._C._functorch._unwrap_for_grad(sum_1, 1);  _unwrap_for_grad = None

        _autograd_grad = torch._functorch.eager_transforms._autograd_grad((sum_1,), [_wrap_for_grad], create_graph = True);  sum_1 = _wrap_for_grad = None
        getitem: "f32[3, 3, 3]" = _autograd_grad[0];  _autograd_grad = None

        _unwrap_for_grad_1: "f32[3, 3, 3]" = torch._C._functorch._unwrap_for_grad(getitem, 1);  getitem = None
...
class GraphModule(torch.nn.Module):
    def forward(self, L_x_: "f32[3, 3, 3]"):
        ...
        _unwrap_for_grad: "f32[3, 3, 3]" = torch._C._functorch._unwrap_for_grad(cos, 1);  cos = None

        sum_1: "f32[]" = add.sum();  add = None

        _unwrap_for_grad_1: "f32[]" = torch._C._functorch._unwrap_for_grad(sum_1, 1);  _unwrap_for_grad_1 = None

        _autograd_grad = torch._functorch.eager_transforms._autograd_grad((sum_1,), [_wrap_for_grad], create_graph = True);  sum_1 = _wrap_for_grad = None
        getitem: "f32[3, 3, 3]" = _autograd_grad[0];  _autograd_grad = None

        _unwrap_for_grad_2: "f32[3, 3, 3]" = torch._C._functorch._unwrap_for_grad(getitem, 1);  getitem = None
...
class GraphModule(torch.nn.Module):
    def forward(self, L_x_: "f32[3, 3, 3]", L_y_: "f32[3, 3, 3]"):
        ...
        _autograd_grad = torch._functorch.eager_transforms._autograd_grad((sum_1,), [_wrap_for_grad, _wrap_for_grad_1], create_graph = True);  sum_1 = _wrap_for_grad = _wrap_for_grad_1 = None
        getitem: "f32[3, 3, 3]" = _autograd_grad[0]
        getitem_1: "f32[3, 3, 3]" = _autograd_grad[1];  _autograd_grad = None

        _unwrap_for_grad_2: "f32[3, 3, 3]" = torch._C._functorch._unwrap_for_grad(getitem, 1);  getitem = None
        _unwrap_for_grad_3: "f32[3, 3, 3]" = torch._C._functorch._unwrap_for_grad(getitem_1, 1);  getitem_1 = None
...
class GraphModule(torch.nn.Module):
    def forward(self, L_x_: "f32[]"):
        ...
        _unwrap_for_grad: "f32[]" = torch._C._functorch._unwrap_for_grad(sum_1, 2);  _unwrap_for_grad = None

        _autograd_grad = torch._functorch.eager_transforms._autograd_grad((sum_1,), [_wrap_for_grad_1], create_graph = True);  sum_1 = _wrap_for_grad_1 = None
        getitem: "f32[]" = _autograd_grad[0];  _autograd_grad = None

        _unwrap_for_grad_1: "f32[]" = torch._C._functorch._unwrap_for_grad(getitem, 2);  getitem = None
        ...
        _unwrap_for_grad_2: "f32[]" = torch._C._functorch._unwrap_for_grad(_unwrap_for_grad_1, 1);  _unwrap_for_grad_2 = None

        _autograd_grad_1 = torch._functorch.eager_transforms._autograd_grad((_unwrap_for_grad_1,), [_wrap_for_grad], create_graph = True);  _unwrap_for_grad_1 = _wrap_for_grad = None
        getitem_1: "f32[]" = _autograd_grad_1[0];  _autograd_grad_1 = None

        _unwrap_for_grad_3: "f32[]" = torch._C._functorch._unwrap_for_grad(getitem_1, 1);  getitem_1 = None
...
class GraphModule(torch.nn.Module):
    def forward(self, L_x_: "f32[3, 3, 3]"):
        ...
        _unwrap_for_grad: "f32[]" = torch._C._functorch._unwrap_for_grad(add, 1);  _unwrap_for_grad = None

        _autograd_grad = torch._functorch.eager_transforms._autograd_grad((add,), [_wrap_for_grad], create_graph = True);  add = _wrap_for_grad = None
        getitem: "f32[3, 3, 3]" = _autograd_grad[0];  _autograd_grad = None
...
class GraphModule(torch.nn.Module):
    def forward(self, L_x_: "f32[4, 3]"):
        ...
        _unpack_dual = torch._unpack_dual(sin, level = 0);  sin = None
        getitem_1: "f32[4, 3]" = _unpack_dual[0]
        getitem_2: "f32[4, 3]" = _unpack_dual[1];  _unpack_dual = None

        _unwrap_for_grad: "f32[4, 3]" = torch._C._functorch._unwrap_for_grad(getitem_1, 2);  getitem_1 = _unwrap_for_grad = None
        _unwrap_for_grad_1: "f32[4, 3]" = torch._C._functorch._unwrap_for_grad(getitem_2, 2);  getitem_2 = None
        ...
        getitem_3: "f32[4, 3, 12]" = split[0];  split = None

        unflatten: "f32[4, 3, 4, 3]" = getitem_3.unflatten(-1, (4, 3));  getitem_3 = None
        return (unflatten,)
""",
        )
...
class GraphModule(torch.nn.Module):
    def forward(self, L_x_: "f32[4, 3]", L_y_: "f32[3, 4]"):
        ...
        _unpack_dual = torch._unpack_dual(sin, level = 0);  sin = None
        getitem_1: "f32[3, 4]" = _unpack_dual[0]
        getitem_2: "f32[3, 4]" = _unpack_dual[1];  _unpack_dual = None

        _unwrap_for_grad: "f32[3, 4]" = torch._C._functorch._unwrap_for_grad(getitem_1, 2);  getitem_1 = _unwrap_for_grad = None
        _unwrap_for_grad_1: "f32[3, 4]" = torch._C._functorch._unwrap_for_grad(getitem_2, 2);  getitem_2 = None
...
class GraphModule(torch.nn.Module):
    def forward(self, L_x_: "f32[4, 3]", L_y_: "f32[3, 4]"):
        ...
        _unwrap_for_grad: "f32[4, 3]" = torch._C._functorch._unwrap_for_grad(_wrap_for_grad, 2);  _wrap_for_grad = None
        ...
        _unwrap_for_grad_1: "f32[3, 4]" = torch._C._functorch._unwrap_for_grad(getitem_1, 2);  getitem_1 = _unwrap_for_grad_1 = None
        _unwrap_for_grad_2: "f32[3, 4]" = torch._C._functorch._unwrap_for_grad(getitem_2, 2);  getitem_2 = None

        _exit_dual_level = torch._C._exit_dual_level(0);  _exit_dual_level = None
        _set_fwd_grad_enabled_1 = torch._C._set_fwd_grad_enabled(True);  _set_fwd_grad_enabled_1 = None
        _jvp_decrement_nesting = torch._C._functorch._jvp_decrement_nesting();  _jvp_decrement_nesting = None

        _remove_batch_dim: "f32[12, 4, 3]" = torch._functorch.predispatch._remove_batch_dim(_unwrap_for_grad, 1, 12, 0);  _unwrap_for_grad = None
        _remove_batch_dim_1: "f32[12, 3, 4]" = torch._functorch.predispatch._remove_batch_dim(_unwrap_for_grad_2, 1, 12, 0);  _unwrap_for_grad_2 = None

        _vmap_decrement_nesting = torch._functorch.predispatch._vmap_decrement_nesting();  _vmap_decrement_nesting = None

        getitem_3: "f32[4, 3]" = _remove_batch_dim[0];  _remove_batch_dim = None

        movedim: "f32[3, 4, 12]" = _remove_batch_dim_1.movedim(0, -1);  _remove_batch_dim_1 = None
        split = movedim.split((12,), dim = -1);  movedim = None
        getitem_4: "f32[3, 4, 12]" = split[0];  split = None

        unflatten: "f32[3, 4, 3, 4]" = getitem_4.unflatten(-1, (3, 4));  getitem_4 = None
        return (unflatten, getitem_3)
""",
        )
...
class GraphModule(torch.nn.Module):
    def forward(self, L_x_: "f32[4, 3]", L_y_: "f32[3, 4]"):
        ...
        _unpack_dual = torch._unpack_dual(_make_dual, level = 0);  _make_dual = None

        sin: "f32[3, 4]" = _wrap_for_grad_1.sin();  _wrap_for_grad_1 = None

        getitem_1: "f32[4, 3]" = _unpack_dual[0]
        getitem_2: "f32[4, 3]" = _unpack_dual[1];  _unpack_dual = None
        _unpack_dual_1 = torch._unpack_dual(sin, level = 0);  sin = None

        _unwrap_for_grad: "f32[4, 3]" = torch._C._functorch._unwrap_for_grad(getitem_1, 2);  getitem_1 = _unwrap_for_grad = None
        _unwrap_for_grad_1: "f32[4, 3]" = torch._C._functorch._unwrap_for_grad(getitem_2, 2);  getitem_2 = None

        getitem_3: "f32[3, 4]" = _unpack_dual_1[0];  _unpack_dual_1 = None

        zeros_like: "f32[3, 4]" = torch.zeros_like(getitem_3)

        _unwrap_for_grad_2: "f32[3, 4]" = torch._C._functorch._unwrap_for_grad(getitem_3, 2);  getitem_3 = _unwrap_for_grad_2 = None
        _unwrap_for_grad_3: "f32[3, 4]" = torch._C._functorch._unwrap_for_grad(zeros_like, 2);  zeros_like = None
        ...
        _remove_batch_dim: "f32[12, 4, 3]" = torch._functorch.predispatch._remove_batch_dim(_unwrap_for_grad_1, 1, 12, 0);  _unwrap_for_grad_1 = None
        _remove_batch_dim_1: "f32[12, 3, 4]" = torch._functorch.predispatch._remove_batch_dim(_unwrap_for_grad_3, 1, 12, 0);  _unwrap_for_grad_3 = None

        _vmap_decrement_nesting = torch._functorch.predispatch._vmap_decrement_nesting();  _vmap_decrement_nesting = None

        movedim: "f32[4, 3, 12]" = _remove_batch_dim.movedim(0, -1);  _remove_batch_dim = None
        movedim_1: "f32[3, 4, 12]" = _remove_batch_dim_1.movedim(0, -1);  _remove_batch_dim_1 = None
        split = movedim.split((12,), dim = -1);  movedim = None
        split_1 = movedim_1.split((12,), dim = -1);  movedim_1 = None
        getitem_4: "f32[4, 3, 12]" = split[0];  split = None
        getitem_5: "f32[3, 4, 12]" = split_1[0];  split_1 = None

        unflatten: "f32[4, 3, 4, 3]" = getitem_4.unflatten(-1, (4, 3));  getitem_4 = None
        unflatten_1: "f32[3, 4, 4, 3]" = getitem_5.unflatten(-1, (4, 3));  getitem_5 = None
        return (unflatten_1, unflatten)
""",
        )
...
class GraphModule(torch.nn.Module):
    def forward(self, L_v_: "f32[3, 3]", L_x_: "f32[3, 3]"):
        ...
        _unpack_dual = torch._unpack_dual(sum_1, level = 0);  sum_1 = None
        getitem: "f32[]" = _unpack_dual[0]
        getitem_1: "f32[]" = _unpack_dual[1];  _unpack_dual = None

        _unwrap_for_grad: "f32[]" = torch._C._functorch._unwrap_for_grad(getitem, 1);  getitem = None
        _unwrap_for_grad_1: "f32[]" = torch._C._functorch._unwrap_for_grad(getitem_1, 1);  getitem_1 = None
...
class GraphModule(torch.nn.Module):
    def forward(self, L_v_: "f32[3, 3]", L_x_: "f32[3, 3]"):
        ...
        sin: "f32[3, 3]" = _make_dual.sin()

        _unwrap_for_grad: "f32[3, 3]" = torch._C._functorch._unwrap_for_grad(_make_dual, 1);  _make_dual = None
        ...
        _unwrap_for_grad_1: "f32[]" = torch._C._functorch._unwrap_for_grad(getitem, 1);  getitem = None
        _unwrap_for_grad_2: "f32[]" = torch._C._functorch._unwrap_for_grad(getitem_1, 1);  getitem_1 = None
...
class GraphModule(torch.nn.Module):
    def forward(self, L_x_: "f32[3, 3, 3]"):
        ...
        _make_dual: "f32[3, 3, 3]" = torch._make_dual(l_x_, l_x_, level = 0);  l_x_ = None
        ...
        _make_dual_1: "f32[3, 3, 3]" = torch._make_dual(_make_dual, _make_dual, level = 0);  _make_dual = None
        ...
        _unwrap_for_grad: "f32[3, 3, 3]" = torch._C._functorch._unwrap_for_grad(getitem, 2);  getitem = None
        _unwrap_for_grad_1: "f32[3, 3, 3]" = torch._C._functorch._unwrap_for_grad(getitem_1, 2);  getitem_1 = None

        _set_fwd_grad_enabled_2 = torch._C._set_fwd_grad_enabled(True);  _set_fwd_grad_enabled_2 = None
        _jvp_decrement_nesting = torch._C._functorch._jvp_decrement_nesting();  _jvp_decrement_nesting = None

        _unpack_dual_1 = torch._unpack_dual(_unwrap_for_grad, level = 0);  _unwrap_for_grad = None
        _unpack_dual_2 = torch._unpack_dual(_unwrap_for_grad_1, level = 0);  _unwrap_for_grad_1 = None
        ...
        _unwrap_for_grad_2: "f32[3, 3, 3]" = torch._C._functorch._unwrap_for_grad(getitem_2, 1);  getitem_2 = None
        _unwrap_for_grad_3: "f32[3, 3, 3]" = torch._C._functorch._unwrap_for_grad(getitem_3, 1);  getitem_3 = None
        _unwrap_for_grad_4: "f32[3, 3, 3]" = torch._C._functorch._unwrap_for_grad(getitem_4, 1);  getitem_4 = None
        _unwrap_for_grad_5: "f32[3, 3, 3]" = torch._C._functorch._unwrap_for_grad(getitem_5, 1);  getitem_5 = None
